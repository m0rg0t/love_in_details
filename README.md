...
Парный квиз для двоих в формате VK Mini App. Можно выбрать короткие «3 вопроса дня» или полный квиз из 12 вопросов, по очереди ответить на одном устройстве и увидеть, где взгляды совпадают, а где различаются.

Это не тест на совместимость — это спокойный инструмент для разговора о важном.

Незавершённый квиз автоматически сохраняется в браузере на семь дней. При
возвращении приложение предлагает продолжить с того же участника и вопроса;
после завершения локальная копия прогресса удаляется. Межстраничная реклама не
прерывает передачу телефона и запрашивается только перед раскрытием подробного
разбора результатов, с обязательным fail-open поведением.
